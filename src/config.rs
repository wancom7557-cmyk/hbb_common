...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("wancom.asuscomm.com".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["wancom.asuscomm.com"];
pub const RS_PUB_KEY: &str = "clPZFEAezuylyhBQcXbFvG3IBPT6EIuMt5YEUJ6b01E=";
